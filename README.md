...
- **List Management:**
  - Reorder images using **"Move Up"** and **"Move Down"** buttons to control their sequence in the final PDF.
  - Remove unwanted images from the list.
- **Page Orientation:** Choose between **Portrait** or **Landscape** layouts for your PDF pages.
- **Fit to Page:** Images are automatically scaled to fit within the page while preserving their aspect ratio.
- **Status Bar:** Get real-time feedback on the application’s status, from selecting files to conversion.
...
You will also need two Python libraries: **Pillow** for image processing and **ReportLab** for PDF generation.
